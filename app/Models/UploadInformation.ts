...
export default class UploadInformation extends BaseModel {
  ...
  @column({ columnName: "CIN_COMUNA_BARRIO", serializeAs: "commune" })
  public commune: string;

  @column({ columnName: "CIN_VIGENCIA", serializeAs: "validity" })
  public validity: string;

  @column({ columnName: "CIN_INFORMACION", serializeAs: "information" })
  public information: string;

  @column({ columnName: "CIN_NOMBRE_ARCHIVO", serializeAs: "fileName" })
