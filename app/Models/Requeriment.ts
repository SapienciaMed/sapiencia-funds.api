...
export default class Requeriment extends BaseModel {
  ...
  @column({ isPrimary: true, columnName: "RRE_CODIGO", serializeAs: "id" })
  public id: number;
  @column({ columnName: "RRE_CODRCO_REGLAMENTO", serializeAs: "codReglament" })
  public codReglament: number;
  @column({ columnName: "RRE_ACTIVO", serializeAs: "active" })
  public active: boolean;
  @column({ columnName: "RRE_PORCENTAJE", serializeAs: "percent" })
