...
export default class Citation extends BaseModel {
  ...
  @column({ isPrimary: true, columnName: "CTA_CODIGO ", serializeAs: "id" })
  public id: number;
  ...
  public dateAprobation: string | DateTime;
  @column({ columnName: "CTA_CODIGO", serializeAs: "idCitation" })
  public idCitation: number;
