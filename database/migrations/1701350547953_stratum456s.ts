...
export default class extends BaseSchema {
  protected tableName = 'CFE_CONTROL_FINANCIERO_ESTRATOS456'
  ...
  public async up() {
    this.schema.createTable(this.tableName, (table) => {
      ...
      table.foreign("CFE_CODPPR_RECURSO_PRIORIZACION", "FK_CFE456_CODPPR").references("PRR_CODIGO").inTable("PRR_PRIORIZACION_RECURSOS")
    })
  }
